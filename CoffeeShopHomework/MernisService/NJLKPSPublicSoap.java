...
public class NJLKPSPublicSoap
{
    ...
    public NJLKPSPublicSoap(){}

    public NJLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NJLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NJLExtendedSoapSerializationEnvelope envelope= new NJLExtendedSoapSerializationEnvelope(NJLExtendedSoapSerializationEnvelope.VER11);
