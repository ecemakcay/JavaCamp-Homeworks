...
public class NJLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NJLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NJLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NJLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NJLDateTimeConverter dateTimeConverter = new NJLStandardDateTimeConverter();

    public NJLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NJLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NJLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NJLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NJLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NJLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
